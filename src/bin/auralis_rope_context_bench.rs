...
fn child(
    ...
    println!(
        "rope_context_child | policy={} context={} block={} train_steps={} optimizer_step={} iterations={} repeats={} median_ns={} tok_per_s={:.3} peak_rss_kib={} params={} loss={:.6} ppl={:.6}",
        policy.as_str(),
        context,
        cfg.block,
        train_steps,
...
fn main() {
    ...
    println!(
        "rope_context_protocol | seed=659918 vocab=8 n_embd=8 n_head=2 n_layer=2 block=32 n_ff=16 batch=2 accum=2 lr=0.003 clip=1 train_steps={} iterations={} repeats={}",
